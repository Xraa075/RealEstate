        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <!-- Search and Filter -->
                    <div class="mb-4">
                        <form action="{{ route('manager.asset-requests.index') }}" method="GET" class="flex flex-wrap gap-4">
                            <div class="flex-1">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($assetRequests as $request)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <a href="{{ route('manager.asset-requests.show', $request) }}" class="text-indigo-600 hover:text-indigo-900">View</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
