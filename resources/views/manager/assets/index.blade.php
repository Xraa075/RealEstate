        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6">
                        <form action="{{ route('manager.assets.index') }}" method="GET" class="space-y-4">
                            ...
                            <div class="flex justify-between items-center">
                                <div class="flex gap-2">
                                    ...
                                    <a href="{{ route('manager.assets.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400 focus:bg-gray-400 active:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                        Clear
                                    </a>
                                </div>
                                ...
                                @forelse ($assets as $asset)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap space-x-2">
                                            <a href="{{ route('manager.assets.show', $asset) }}" class="text-indigo-600 hover:text-indigo-900">View</a>
