        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('manager.assets.documents.update', [$asset, $document]) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                            ...
                            @if($document->file_path)
                                <div class="mt-2 p-3 bg-gray-50 rounded-md">
                                    <p class="text-sm text-gray-600">Current file:
                                        <a href="{{ route('manager.assets.documents.download', [$asset, $document]) }}" class="text-indigo-600 hover:text-indigo-900 font-medium">
