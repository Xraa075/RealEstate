...
class AssetDocumentController extends Controller
{
    ...
    public function index(LandAsset $asset)
    {
        ...
        return view('admin.assets.documents.index', compact('asset', 'documents'));
    }
    ...
    {
        return view('admin.assets.documents.create', compact('asset'));
    }
    ...
    public function store(Request $request, LandAsset $asset)
    {
        ...
        return redirect()->route('admin.assets.documents.index', $asset)
    ...
    public function show(LandAsset $asset, AssetDocument $document)
    {
        ...
        return view('admin.assets.documents.show', compact('asset', 'document'));
    }
    ...
    public function edit(LandAsset $asset, AssetDocument $document)
    {
        ...
        return view('admin.assets.documents.edit', compact('asset', 'document'));
    }
