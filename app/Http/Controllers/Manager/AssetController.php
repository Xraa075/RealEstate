...
class AssetController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manager.assets.index', compact('assets'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $asset = LandAsset::create($validated);

        // Log the activity
        ActivityLog::log(
            'asset_create',
            'Created new land asset "' . $asset->name . '"',
            $request
        );
     ...
     * @return \Illuminate\Http\RedirectResponse
     */
    public function destroy(LandAsset $asset, Request $request)
    {
        // Log the activity before deleting
        ActivityLog::log(
            'asset_delete',
            'Deleted land asset "' . $asset->name . '" (Code: ' . $asset->asset_code . ')',
            $request
        );
